...
RSpec.describe 'jmri plugin' do
  ...
  it 'converts image tag without alt text' do
    write_and_process_page('>![](short.png)')
    expect_rendered_output('{% jmri jmri "/image.png" alt="" %}')
  end

  it 'converts image tag without alt text' do
    write_and_process_page('>![](longlonglonglonglonglonglonglonglonglonglonglonglonglonglong.png)')
    expect_rendered_output('{% jmri jmri "/image.png" alt="" %}')
  end
  ...
  it "converts quoted" do
    write_and_process_page(">![Alt_a](../assets/images/stepfct1.png)")
    expect_rendered_output('<blockquote>{% jmri jmri "/image.png" alt="Alt Text" %}</blockquote>')
  end
